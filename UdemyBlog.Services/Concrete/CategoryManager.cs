...
using UdemyBlog.Services.Abstract;
using UdemyBlog.Shared.Utilities.Results.Abstract;
using UdemyBlog.Shared.Utilities.Results.ComplexTypes;
using UdemyBlog.Shared.Utilities.Results.Concrete;

namespace UdemyBlog.Services.Concrete
{
    public class CategoryManager : ICategoryService
    {
        ...
        public async Task<IDataResult<Category>> Get(int categoryId)
        {
            ...
            return new DataResult<Category>(ResultStatus.Error, "Böyle Bir Kategori Bulunamdı.",null);
        }
        ...
        public async Task<IResult> HardDelete(int categoryId)
        {
            ...
            if (category != null)
            {
                ...
                return new Result(ResultStatus.Success, $"{category.Name} Adlı Kategori Başarılı Bir Şekilde Veritabanından Silinmiştir.");
            }
            return new Result(ResultStatus.Error, "Böyle Bir Kategori Bulunamadı.");
        }
